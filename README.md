...
<img src="man/figures/README-cvine-xmod-1.png" title="plot of chunk cvine-xmod" alt="plot of chunk cvine-xmod" width="100%" /><img src="man/figures/README-cvine-xmod-2.png" title="plot of chunk cvine-xmod" alt="plot of chunk cvine-xmod" width="100%" /><img src="man/figures/README-cvine-xmod-3.png" title="plot of chunk cvine-xmod" alt="plot of chunk cvine-xmod" width="100%" />
...
#> Data generating process estimated SNR (for each outcome model): 0.25 0.06 0.01
...
#> |       | power|   n|  snr|
#> |:------|-----:|---:|----:|
#> |F-test |  0.97| 100| 0.25|
#> |F-test |  0.40| 100| 0.06|
#> |F-test |  0.09| 100| 0.01|
#> |F-test |  1.00| 300| 0.25|
#> |F-test |  0.99| 300| 0.06|
#> |F-test |  0.24| 300| 0.01|
```


```r
mpower::plot_summary(curve , crit = "pval", thres = 0.05, how = "lesser")
#> Error in UseMethod("plot_summary", sim): no applicable method for 'plot_summary' applied to an object of class "mpower_SimCurve"
```
...
<img src="man/figures/README-est-mplot-1.png" title="plot of chunk est-mplot" alt="plot of chunk est-mplot" width="100%" />
...
#> |:------|-----:|
#> |F-test |     1|
mpower::plot_summary(power , crit = "pval", thres = 0.05, how = "lesser")
#> Error in UseMethod("plot_summary", sim): no applicable method for 'plot_summary' applied to an object of class "mpower_Sim"
```
...
#> |          | power|    n|  snr|
#> |:---------|-----:|----:|----:|
#> |Education | 0.320| 1000| 0.03|
#> |HHIncome  | 0.220| 1000| 0.03|
#> |HomeOwn   | 0.190| 1000| 0.03|
#> |Poverty   | 0.545| 1000| 0.03|
#> |Age       | 0.765| 1000| 0.03|
#> |Education | 0.575| 2000| 0.03|
#> |HHIncome  | 0.350| 2000| 0.03|
#> |HomeOwn   | 0.180| 2000| 0.03|
#> |Poverty   | 0.805| 2000| 0.03|
#> |Age       | 0.975| 2000| 0.03|
#> |Education | 0.760| 3000| 0.03|
#> |HHIncome  | 0.510| 3000| 0.03|
#> |HomeOwn   | 0.290| 3000| 0.03|
#> |Poverty   | 0.910| 3000| 0.03|
#> |Age       | 0.995| 3000| 0.03|
#> |Education | 0.880| 4000| 0.03|
#> |HHIncome  | 0.580| 4000| 0.03|
#> |HomeOwn   | 0.190| 4000| 0.03|
#> |Poverty   | 0.975| 4000| 0.03|
#> |Age       | 1.000| 4000| 0.03|
#> |Education | 0.935| 5000| 0.03|
#> |HHIncome  | 0.655| 5000| 0.03|
#> |HomeOwn   | 0.255| 5000| 0.03|
#> |Poverty   | 0.995| 5000| 0.03|
#> |Age       | 1.000| 5000| 0.03|
mpower::plot_summary(curve, crit = "pval", thres = 0.05, how = "lesser")
#> Error in UseMethod("plot_summary", sim): no applicable method for 'plot_summary' applied to an object of class "mpower_SimCurve"
```
